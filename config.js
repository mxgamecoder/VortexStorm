...
global.github = process.env.GITHUB || "https://github.com/mxgamecoder/VortexStorm";
...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || process.env.IMAGE || "https://i.imgur.com/INRLrpM.jpeg";
global.devs = "2349021506036";
global.sudo = process.env.SUDO || "2349021506036";
global.owner = process.env.OWNER_NUMBER || "2349021506036";
...
module.exports = {
  ...
  LANG: (process.env.THEME || "S T O R M").toUpperCase(),
};
global.rank = "updated";
