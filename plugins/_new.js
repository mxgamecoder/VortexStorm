...
/* smd({
 ...
 smd({
   ...
   try {
     ...
     if (!_0x11eeb1) {
       return await _0x7587f6.reply("_Need fileName, Example: document 𝙎𝙏𝙊𝙍𝙈| caption_");
     }
