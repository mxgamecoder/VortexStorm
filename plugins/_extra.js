...
smd({
  ...
  try {
    ...
    const _0x338160 = Object.entries(_0x5af784).map(([_0x4630e3, _0x3a7f93]) => 
      `\t*${_0x4630e3?.split("\n").join(" ") || "unknown"}*  ➪  _${_0x3a7f93}_`
    ).join("\n");
...
smd({
  ...
  if (!_0x32c078 || !_0x32c078.includes("@")) {
    return await _0x2a677e.reply("*Mention/reply to a user to check their character!*");
  }

  const _0x5845d4 = [
    "Sigma", "Generous", "Grumpy", "Overconfident", "Obedient", 
    "Good", "Simple", "Kind", "Patient", "Pervert", 
    "Cool", "Helpful", "Brilliant", "Sexy", "Hot", 
    "Gorgeous", "Cute", "Fabulous", "Funny"
  ];
...
👤 Character of @${_0x32c078.split("@")[0]} is *${_0x2f5d93}* 🔥⚡
