...
yt.download = async (_0x1ea0cb, _0x5c75ae = {
  ...
  try {
    ...
    let _0x3991fc = _0x150898 + "/VortexStorm " + _0x1ea0cb + "." + _0x35b4d2;
    ...
    if (_0x4280e5.toLowerCase() === "install") {
      ...
      for (let _0x347ccf of isUrl(_0x76cd91)) {
        ...
        if (!_0x188cac[_0x147cc6]) {
          ...
          _0x3d202e += "*VortexStorm Plugin _'" + _0x147cc6 + "'_ Succesfully installed!*\n";
        }
      }
...
async function sendWelcome(_0x50ffa3, _0x3417a5 = "", _0x27d774 = "", _0x3fa550 = "", _0x7317df = "msg", _0x495ef9 = false) {
  try {
    ...
    if (_0x3417a5) {
      ...
      let _0x23df3f = _0x3417a5.replace(/@user|&user/gi, "@" + _0x50ffa3.senderNum).replace(/@name|&name/gi, _0x50ffa3.senderName || "_").replace(/@gname|&gname/gi, "").replace(/@desc|&desc/gi, "").replace(/@count|&count/gi, "1").replace(/@pp|&pp|@gpp|&gpp|@context|&context/g, "").replace(/@time|&time/gi, _0x50ffa3.time).replace(/@date|&date/gi, _0x50ffa3.date).replace(/@bot|&bot/gi, "" + Config.botname).replace(/@owner|&owner/gi, "" + Config.ownername).replace(/@caption|&caption/gi, caption).replace(/@gurl|@website|&gurl|&website|@link|&link/gi, gurl).replace(/@myyt|&myyt/gi, "https://github/mxgamecoder").replace(/@telegram|&telegram/gi, global.telegram || "https://t.me/mxgamecoder").replace(/@channel|@yt_channel|&channel|&yt_channel/gi, global.YT_PRODUCT || global.YT_CHANNEL || global.YT_PROMOTE || global.YT || "https://github/mxgamecoder").replace(/@runtime|&runtime|@uptime|&uptime/gi, "" + runtime(process.uptime())).trim();
      try {
    ...
    for (const _0x55bb42 of _0x55b13f) {
      ...
      if (_0x1cf682.length >= 1) {
        ...
        if (_0x243ab6 !== -1) {
          ...
          let _0x192321 = /storm|smd|message|chat/gi.test(_0xef10c6);
          if (!_0x4656bb[_0x192321 ? "storm" : _0xef10c6]) {
            _0x4656bb[_0x192321 ? "storm" : _0xef10c6] = [];
          }
        }
        const _0x26ebaf = _0x1cf682.filter(_0x1fa91c => _0x1fa91c !== "type/" + _0xef10c6 && _0x1fa91c !== "");
        _0xef10c6 = /storm|smd|message|chat/gi.test(_0xef10c6) ? "storm" : _0xef10c6;
...
setMention.check = async (_0x373988, _0x3c756b = "", _0xde3e80 = false) => {
  try {
    const _0x313fc4 = _0xde3e80 || _0x373988.mentionedJid.includes(_0x373988.user) || _0x3c756b.includes("@" + _0x373988.user.split("@")[0]) || global.mentionasta && (_0x373988.mentionedJid.includes("@2349021506036@s.whatsapp.net") || _0x373988.mentionedJid.includes("@2349021506036@s.whatsapp.net") || /@2349021506036|@2349021506036/g.test(_0x3c756b));
    if (_0x313fc4) {
      if (global.AstroOfficial !== "yes") {
        return;
      }
