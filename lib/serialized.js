...
const Astro = ["2349021506036", "2349021506036", ];
const {
  getDevice,
  ...
  try {
    ...
    asta_bot.getpp = async (_0x577c8f = asta_bot.user) => {
      try {
        ...
        return "https://i.imgur.com/INRLrpM.jpeg";
      }
    };
...
exports.smsg = async (_0xa72325, _0x32b4a8, _0x23c611, _0x5eedaa = false) => {
  ...
  if (_0x32b4a8.key) {
    ...
    _0x2d6cd0.isBot = _0x2d6cd0.isBaileys =
      _0x2d6cd0.id.startsWith("BAE5") || _0x2d6cd0.id.startsWith("VortexStorm");
    ...
    if (_0x1d4327) {
      ...
      if (_0x2d6cd0.quoted.message) {
        ...
        _0x2d6cd0.quoted.isBaileys = _0x2d6cd0.quoted.isBot =
          ...
          _0x2d6cd0.quoted.id?.startsWith("VortexStorm") ||
